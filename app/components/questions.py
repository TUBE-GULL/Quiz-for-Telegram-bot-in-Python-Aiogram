...
quiz_data = [
    ...
    {# question 10
        'question': 'Как отличить магический метод от обычного метода в Python?',
        'options': ['Магические методы заключены в двойные подчеркивания, например, __init__', 'Магические методы начинаются с @', 'Обычные методы всегда публичные', 'Магические методы используются только в классах'],
        'correct_option': 0
    }
]
